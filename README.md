# 🚀 BantenPulse - Integrasi Google Sheets sebagai CMS

**Gunakan Google Sheets sebagai database artikel untuk website BantenPulse. Generator otomatis membuat HTML dan memperbarui konten dengan mudah!**
...
# 1. Buat project (misal: "bantenpulse-News")
